...
export default function Home() {
  ...
  return (
    <SnackbarProvider position={position}>
      <div className="bg-white text-zinc-800 grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
        ...
        <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center">
          <Link className="flex gap-1 items-center" href="https://www.youtube.com/@farzany">
            <span>made with</span>
